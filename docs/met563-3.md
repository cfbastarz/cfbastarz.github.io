...
* Artigo - [The Ensemble Kalman Filter: Theoretical Formulation and PracticalImplementation](https://x.gd/qqgdn)
* Artigo - [Understanding the Ensemble Kalman Filter](https://x.gd/szoC9)
* Artigo - [A New Approach to Linear Filteringand Prediction Problems](https://x.gd/SFMtF)
* Artigo - [Sequential data assimilation with a nonlinear quasi-geostrophic model using Monte Carlo methods to forecast error statistics](https://x.gd/3wEZv)
* Artigo - [Inclusion of Global Navigation Satellite System radio occultation data intoCenter for Weather Forecast and Climate Studies Local Ensemble TransformKalman Filter (LETKF) using the Radio Occultation Processing Package as anobservation operator](https://x.gd/4pvTm)
